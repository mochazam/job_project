...
<html lang="en">
<head>
<title>Laporan Tahapan Pondasi | Quality Control Application</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header"><span style="color: maroon">Laporan</span> Tahapan Pondasi</h3>
			<p class="agileits_dummy_para">Dapat melihat seluruh laporan langsung atau lihat laporan berdasarkan periode tanggal</p>
			<br><br>
			

			<form id="form_laporan" action="<?php echo base_url();?>pondasi/laporantgl" method="POST">
				<div class="row">
			...
			<br>		
			<a href="<?php echo base_url() ?>pondasi/laporan"><button class="btn btn-primary"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Tampilkan Semua Laporan</button></a><br><br>
			<?php } ?>
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black;">
												<form id="Detail" action="<?php echo base_url();?>pondasi/detail/<?php echo $u->id_pondasi ?>" method="POST">
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Laporan <span>Tahapan Pondasi</span></h2>
				<p class="agileits_dummy_para">Halaman laporan Pondasi.</p>
