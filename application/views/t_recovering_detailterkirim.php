...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			...
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>recovering/terkirim"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
			...
			<script>
				...
				function ayo(){
					...
					$("<br><br><br><br><br><br>").appendTo(".enter1");
