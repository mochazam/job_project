...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			...
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>konstruksi/laporan"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<p style="font-style: italic;">Keteragan : <?php echo $posting->ket ?></p>
						...
						<!-- <div class="row" style="margin-bottom: 5px">
					        ...
					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" data-target="#modalFoto150<?php echo $posting->id_konstruksi ?>" type="button" class="btn btn-sm form-control">
					...
					<?php
						...
						<span class="album-besar sub-album borderfoto">
							...
							<div class="row hilangkan">
								...
								<div class="col-md-6">
								<a href="<?php echo base_url().'konstruksi/lakukan_download_asli/'.$foto->token ?>"><button class="btn btn-warning form-control" style="margin-top: 5px">Download Asli</button></a>
								</div>
							</div>
