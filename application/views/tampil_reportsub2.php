...
<title>KPIM Online | Report Subordinate (yang sudah dinilai)</title>
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                <!-- <li class="active"><a href="#">KPIM Report Subordinat</a></li> -->
	                		...
	                		<li class="dropdown">
			                    <a href="#" class="dropdown-toggle test" data-toggle="dropdown">Report Subordinate yang sudah dinilai
...
<div class="container">
	<div class="background">
		<div id='div1'>
		<h1 style="padding-top: 20px; color: green"><center>Report Subordinate (Yang Sudah Dinilai)</center></h1><br><br>
...
<!-- 
		...
		<div class="row">
			<div class="col-lg-12 table-responsive">
				<table class="table table-bordered table-hover table-striped">
					<thead class="text-center" style="background-color: #5de258;">
					  <tr>
				...
				<tr style="background-color: #6ded68; border:2px solid gray;">
					<td style="text-align: center;"></td>
					<td style="text-align: center;"></td>
		...
		<div class="row ">
		  ...
		  <div style="float: left;"><button class="btn btn-primary" style="font-family: 'Exo 2', sans-serif; margin-top:5px;" onclick="printContent('div1'); window.location.reload();return false;"><span class="glyphicon glyphicon-print"></span> Print Report</button> <text style="color:blue">*Cetak pada akhir penilaian</text></div>
		  				...
		  				<a class= "btn btn-success" href="<?php echo base_url(); ?>reportsub2" style="margin-top:5px; font-family: 'Exo 2', sans-serif;"><h7><i><span class="glyphicon glyphicon-arrow-left"></span> Kembali</i></h7></a>
						<a class= "btn btn-success" href="<?php echo base_url(); ?>home" style="margin-top:5px; font-family: 'Exo 2', sans-serif;"><h7><span class="glyphicon glyphicon-home"></span> Home</h7></a>
