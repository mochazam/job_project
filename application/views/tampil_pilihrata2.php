...
<html>
<head>
	<title>Report Nilai Rata-Rata Karyawan </title>
...
<?php date_default_timezone_set('Asia/Jakarta'); ?>
	...
	<div class="container-fluid" style="max-width: 600px; height: auto; background-color: black; color: white; border:solid 4px orange; border-radius: 15px;">
		<div class="row"> 
			<div class="col-sm-12 text-center" style="padding-top: 10px">Report Nilai Rata-Rata Semua Karyawan</div>
		</div>
	
		<form id="form_kpim" action="<?php echo base_url();?>reportkaryawan/chartrata2/" method="POST">
		...
		<br>
			...
			<div class="col-sm-3 text-center" style="padding-bottom: 15px; padding-top: 5px;"> <button type="submit" name="input"  class="btn btn-warning" style="min-width: 215px; font-family: 'Exo 2', sans-serif;"><span class="glyphicon glyphicon-zoom-in"></span> Tampilkan</button>
			</div>
		</div>
