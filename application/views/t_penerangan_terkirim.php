...
<html lang="en">
<head>
<title>Laporan Terkirim Tahapan Penerangan | Quality Control Application</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header"><span style="color: maroon">Laporan Terkirim</span> Tahapan Penerangan</h3>
			<p class="agileits_dummy_para">Dapat melihat seluruh laporan langsung atau lihat laporan berdasarkan periode tanggal</p>
			<br><br>
			

			<form id="form_laporan" action="<?php echo base_url();?>penerangan/laporantglterkirim" method="POST">
				<div class="row">
			...
			<br>		
			<a href="<?php echo base_url() ?>penerangan/terkirim"><button class="btn btn-primary"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Tampilkan Semua Laporan Terkirim</button></a><br><br>
			<?php } ?>
					...
					<table id="dataTables" class="display table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
				        <thead>
				            <t>
				                ...
				                <th style="text-align: center; color: black">ID Penerangan</th>
				                ...
				                <th style="text-align: center; color: black">Alamat Via</th>
						...
						<tbody >
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black"><?php echo $u->id_penerangan ?></td>
											...
											<td style="text-align: center; color: black">
												<form id="Detail" action="<?php echo base_url();?>penerangan/detailterkirim/<?php echo $u->id_penerangan ?>" method="POST">
													<!-- <input type="text" name="id_penerangan" style="visibility: hidden;" value="<?php echo $u->id_penerangan ?>"> -->
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Laporan Terkirim <span>Tahapan Penerangan</span></h2>
				<p class="agileits_dummy_para">Halaman laporan terkirim penerangan.</p>
