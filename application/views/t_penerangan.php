...
<html lang="en">
<head>
<title>Tahapan Penerangan | Quality Control Application</title>
...
<body >
	<!-- banner -->
	<div class="banner-penerangan jarallax">
...
Sidoarjo - East Java, 61257</p>
								...
								<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
									<nav>
										<ul class="nav navbar-nav">
											...
											<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Penerangan <span class="caret"></span></a>
												<ul class="dropdown-menu">
													<li><a class="hvr-bounce-to-bottom" href="<?php echo base_url() ?>penerangan">Input Penerangan</a></li>
													<li><a class="hvr-bounce-to-bottom" href="<?php echo base_url() ?>penerangan/terkirim">Laporan Terkirim</a></li>          
												</ul>
											</li>
											...
											<li><a href="<?php echo base_url() ?>penerangan/laporan">Laporan Penerangan</a></li>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header">Tahapan <span>Penerangan</span></h3>
			...
			<div class="row">
				...
				<table>
				  <tr>
				    <td>&nbsp Foto KWH Meter &nbsp</td>
				    <td>&nbsp = &nbsp</td>
				    <td>&nbsp 1 Foto &nbsp</td>
				  </tr>
				  <tr>
				    <td>&nbsp Foto Panel Box Atas &nbsp</td>
				    <td>&nbsp = &nbsp</td>
				    <td>&nbsp 1 Foto &nbsp</td>
				  </tr>
				  <tr>
				    <td>&nbsp Foto Penyambungan Kabel &nbsp</td>
				    <td>&nbsp = &nbsp</td>
				    <td>&nbsp 2 Foto &nbsp</td>
				  </tr>
				  <tr>
				    <td>&nbsp Foto Material Penerangan &nbsp</td>
				    <td>&nbsp = &nbsp</td>
			...
			<div class="container">
				<!-- <form id="form_penerangan" action="<?php echo base_url();?>penerangan/create" method="POST"> -->

				<form  action="<?php echo base_url();?>penerangan/create" method="POST">
			...
			<?php 
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<!-- KWH Meter -->
					<?php $data_fotokwhmeter = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'KWH Meter'))->result(); ?>
					<!-- untuk menghitung maks foto -->
					<?php $data_fotokwhmeter2 = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'KWH Meter')); ?>
					<?php $tot_fotokwhmeter = $data_fotokwhmeter2->num_rows(); ?>
					<!-- untuk menghitung maks foto selesai-->
					<!-- KWH Meter selesai-->

					<!-- panel box atas -->
					<?php $data_fotopanelb = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Panel Box Atas'))->result(); ?>
					<!-- untuk menghitung maks foto -->
					<?php $data_fotopanelb2 = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Panel Box Atas')); ?>
					<?php $tot_fotopanelb = $data_fotopanelb2->num_rows(); ?>
					<!-- untuk menghitung maks foto selesai-->
					<!-- panelb Selesai -->

					<!-- Penyambungan kabel -->
					<?php $data_fotopenyambungank = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Penyambungan Kabel'))->result(); ?>
					<!-- untuk menghitung maks foto -->
					<?php $data_fotopenyambungank2 = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Penyambungan Kabel')); ?>
					<?php $tot_fotopenyambungank = $data_fotopenyambungank2->num_rows(); ?>
					<!-- untuk menghitung maks foto selesai-->
					<!-- Penyambungan kabel -->

					<!-- Material penerangan -->
					<?php $data_fotomaterialp = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Material Penerangan'))->result(); ?>
					<!-- untuk menghitung maks foto -->
					<?php $data_fotomaterialp2 = $this->db->get_where('foto_penerangan', array('id_posting' => $posting->id_penerangan, 'jenis_foto' => 'Material Penerangan')); ?>
					<?php $tot_fotomaterialp = $data_fotomaterialp2->num_rows(); ?>
					<!-- untuk menghitung maks foto selesai-->
					<!-- Material penerangan -->



					<!-- untuk falidasi tombol tambah foto penerangan tidak bisa jika foto maksimal -->
					<?php if ($tot_fotokwhmeter >= 1 ){ ?>

					<script>
						$(document).ready(function(){						    
						    $("#kwhmeter<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Maksimal Foto KWH Meter adalah 1 Foto");
						        document.getElementById("kwhmeter<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
					...
					<?php if ($tot_fotopanelb >= 1 ){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#panelb<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Maksimal Foto Panel Box Atas adalah 1 Foto");
						        document.getElementById("panelb<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
					...
					<?php if ($tot_fotopenyambungank >= 2 ){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#penyambungank<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Maksimal Foto Penyambungan Kabel adalah 2 Foto");
						        document.getElementById("penyambungank<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
					...
					<?php if ($tot_fotomaterialp >= 3 ){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#materialp<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Maksimal Foto Material Penerangan adalah 3 Foto");
						        document.getElementById("materialp<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
					...
					<!-- untuk falidasi foto penerangan harus lengkap sebelum simpan dan kirim -->
					<?php if ($tot_fotokwhmeter < 1 ){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#send<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Foto KWH Meter harus 1 Foto");
						        document.getElementById("send<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
					...
					<script>
						$(document).ready(function(){						    
						    $("#send<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Foto Panel Box Atas harus 1 Foto");
						        document.getElementById("send<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
					...
					<script>
						$(document).ready(function(){						    
						    $("#send<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Foto Penyambungan Kabel harus 2 Foto");
						        document.getElementById("send<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
					...
					<!-- untuk falidasi foto penyambungan Penerangan harus lengkap sebelum simpan dan kirim -->
					<?php if ($tot_fotomaterialp < 3 ){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#send<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Foto Material Penerangan harus 3 Foto");
						        document.getElementById("send<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
					...
					<?php if (!empty($data_fotokwhmeter || $data_fotopanelb || $data_fotopenyambungank || $data_fotomaterialp )){ ?>
					<script>
						$(document).ready(function(){						    
						    $("#editku<?php echo $posting->id_penerangan ?>").click(function(){
						        alert("Sudah ada foto yang diupload, Hapus dulu foto jika ingin edit laporan");
						        document.getElementById("editku<?php echo $posting->id_penerangan ?>").setAttribute("disabled", "");
						    });
						    return false;
						});
			  		</script>
				...
				<div class="col-md-12">
					...
					<?php if (!empty($data_fotokwhmeter)){ ?>	
					<div class="col-md-12">
					<h3>Foto KWH Meter :</h3>
					</div>				

					<?php } ?>

					<?php
						foreach($data_fotokwhmeter as $foto) { ?>
						...
						<span class="album-besar sub-album">
							...
							<div class="fotoku">
							<img class="img-responsive" src="<?php echo base_url() ?>/assets/upload-foto/penerangan/<?= $foto->nama_foto ?>">
							</div>
							</a>
						  ...
						  <div class="modal-dialog vertical-align-center" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
									<form id="form_kpim" method="POST" action="<?php echo base_url();?>penerangan/hapus_fotosatu/<?php echo $foto->id?>">
					...
					<?php if (!empty($data_fotopanelb)){ ?>	
					<div class="col-md-12" style="border-top: 2px dashed gray">
					<h3>Foto Panel Box Atas :</h3>
					</div>				

					<?php } ?>

					<?php
						foreach($data_fotopanelb as $foto) { ?>
					...
					<?php if (!empty($data_fotopenyambungank)){ ?>	
					<div class="col-md-12" style="border-top: 2px dashed gray">
					<h3>Foto Penyambungan Kabel :</h3>
					</div>				

					<?php } ?>

					<?php
						foreach($data_fotopenyambungank as $foto) { ?>
					...
					<?php if (!empty($data_fotomaterialp)){ ?>	
					<div class="col-md-12" style="border-top: 2px dashed gray">
					<h3>Foto Material Penerangan :</h3>
					</div>				

					<?php } ?>

					<?php
						foreach($data_fotomaterialp as $foto) { ?>
					...
					<div class="row" style="margin-bottom: 5px">
						<div class="col-md-3">
							<button data-toggle="modal" style="height: 50px; color: white; background-color: #184169" data-target="#modalkwhmeter<?php echo $posting->id_penerangan ?>" type="button" id="kwhmeter<?php echo $posting->id_penerangan ?>" class="btn btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto KWH Meter ( 1 Foto )
					        </button>
				        </div>

				        <div class="col-md-3">
					        <button data-toggle="modal" style="height: 50px; color: white; background-color: #13314D" id="panelb<?php echo $posting->id_penerangan ?>" data-target="#modalpanelb<?php echo $posting->id_penerangan ?>" type="button" class="btn btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto Panel Box Atas ( 1 Foto )
					        </button>
				    	</div>

				        <div class="col-md-3">
					        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" id="penyambungank<?php echo $posting->id_penerangan ?>" data-target="#modalpenyambungank<?php echo $posting->id_penerangan ?>" type="button" class="btn btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto Penyambungan Kabel ( 2 Foto )
					        </button>
				    	</div>

				    	<div class="col-md-3">
					        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" id="materialp<?php echo $posting->id_penerangan ?>" data-target="#modalmaterialp<?php echo $posting->id_penerangan ?>" type="button" class="btn btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto Material Penerangan ( 3 Foto )
					        </button>
				    	</div>
				    </div>
				    ...
				    <div class="row" style="margin-bottom: 10px">
				        <div class="col-md-6">
							<button data-toggle="modal" data-target="#myModal<?php echo $posting->id_penerangan ?>" style="height: 40px" id="editku<?php echo $posting->id_penerangan ?>" type="button" class="btn btn-warning btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-edit"></span> Edit
					        </button>
				        </div>

				        <div class="col-md-6">
					        <button data-toggle="modal" data-target="#modalHapus<?php echo $posting->id_penerangan ?>" style="height: 40px" type="button" class="btn btn-danger btn-sm form-control">
					        <span  style="color: white" class="glyphicon glyphicon-trash"></span> Hapus
					        </button>
				        </div>
			        </div>
					...
					<div class="row">
						<div class="col-md-12">
						<button type="button" class="btn btn-primary btn-sm form-control" style="height: 50px" data-toggle="modal" id="send<?php echo $posting->id_penerangan ?>" data-target="#myModalsend<?php echo $posting->id_penerangan ?>">Simpan dan Kirim</button>
						</div>
					</div>
					<br>
					<!-- <hr> -->
					...
					<div class="modal fade" id="myModalsend<?php echo $posting->id_penerangan ?>" role="dialog" style="padding-top: 100px;">
						<div class="modal-dialog modal-lg">
						  <div class="modal-content">
						    ...
						    <form id="form_kpim" action="<?php base_url();?>penerangan/updatestatus" method="POST">
						    <input type='hidden' class="form-control" name="id" value="<?php echo $posting->id_penerangan ?>" /> 
					...
					<!-- Modal upload penerangan-->
					 <div class="modal fade" id="modalkwhmeter<?php echo $posting->id_penerangan ?>" role="dialog">
					    <div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h4 class="modal-title">Tambah Foto KWH Meter (1 Foto)</h4>
					        </div>
					        <div class="modal-body">
					        	<!-- isi -->
						        <div class="row">
					        	...
					        	<div class="dropzone" id="ikiftkwhmeter<?php echo $posting->id_penerangan ?>">
								...
								<script type="text/javascript">
								var jumlahfoto = <?php echo $tot_fotokwhmeter; ?>;
								...
								var foto_upload= new Dropzone("#ikiftkwhmeter<?php echo $posting->id_penerangan ?>",{
								url: "<?php echo base_url('penerangan/proses_upload/') ?>" + "<?php echo $posting->id_penerangan ?>",
								maxFilesize: 5,
								maxFiles: maksimal,
								method:"post",
								// data:{}
								...
								foto_upload.on("removedfile",function(a){
									...
									$.ajax({
										type:"post",
										data:{token:token},
										url:"<?php echo base_url('penerangan/remove_foto') ?>",
										cache:false,
										dataType: 'json',
										success: function(){
					        ...
					        <div class="modal-footer">
					        <a href="<?= base_url(); ?>penerangan"><button type="button" class="col-xs-12 col-sm-12 col-lg-12 btn btn-primary">Selesai</button></a>
					 ...
					 <!-- Modal upload-->
					<div class="modal fade" id="modalpanelb<?php echo $posting->id_penerangan ?>" role="dialog">
					    <div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h4 class="modal-title">Tambah Foto Panel Box Atas (1 Foto)</h4>
					        </div>
					        <div class="modal-body">
					        	<!-- isi -->
						        <div class="row">
					        	...
					        	<div class="dropzone" id="ikiftpanelb<?php echo $posting->id_penerangan ?>">
								  <div class="dz-message">
								   <h3>Klik di sini atau Drop gambar di sini</h3>
								  </div>
								</div>
								...
								<script type="text/javascript">
								var jumlahfoto = <?php echo $tot_fotopanelb; ?>;
								var maksimal = 1 - jumlahfoto; 								

								Dropzone.autoDiscover = false;

								var foto_upload= new Dropzone("#ikiftpanelb<?php echo $posting->id_penerangan ?>",{
								url: "<?php echo base_url('penerangan/proses_upload/') ?>" + "<?php echo $posting->id_penerangan ?>",
								maxFilesize: 5,
								maxFiles: maksimal,
								method:"post",
					...
					<!-- Modal upload-->
					<div class="modal fade" id="modalpenyambungank<?php echo $posting->id_penerangan ?>" role="dialog">
					    <div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h4 class="modal-title">Tambah Foto Penyambungan Kabel (2 Foto)</h4>
					        </div>
					        <div class="modal-body">
					        	<!-- isi -->
						        <div class="row">
					        	...
					        	<div class="dropzone" id="ikiftpenyambungank<?php echo $posting->id_penerangan ?>">
								  <div class="dz-message">
								   <h3>Klik di sini atau Drop gambar di sini</h3>
								  </div>
								</div>
								...
								<script type="text/javascript">
								var jumlahfoto = <?php echo $tot_fotopenyambungank; ?>;
								var maksimal = 2 - jumlahfoto;
								

								Dropzone.autoDiscover = false;

								var foto_upload= new Dropzone("#ikiftpenyambungank<?php echo $posting->id_penerangan ?>",{
								url: "<?php echo base_url('penerangan/proses_upload/') ?>" + "<?php echo $posting->id_penerangan ?>",
								maxFilesize: 5,
								maxFiles: maksimal,
								method:"post",
								...
								// Jenis Foto
								foto_upload.on("sending",function(a,b,c){
									a.jenis_foto="Penyambungan Kabel";
									c.append("jenis_foto",a.jenis_foto);
								});
					 ...
					 <!-- Modal upload-->
					<div class="modal fade" id="modalmaterialp<?php echo $posting->id_penerangan ?>" role="dialog">
					    <div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          <button type="button" class="close" data-dismiss="modal">&times;</button>
					          <h4 class="modal-title">Tambah Foto Material Penerangan (3 Foto)</h4>
					        </div>
					        <div class="modal-body">
					        	<!-- isi -->
						        <div class="row">
					        	...
					        	<div class="dropzone" id="ikiftmaterialp<?php echo $posting->id_penerangan ?>">
								  <div class="dz-message">
								   <h3>Klik di sini atau Drop gambar di sini</h3>
								  </div>
								</div>
								...
								<script type="text/javascript">
								var jumlahfoto = <?php echo $tot_fotomaterialp; ?>;
								var maksimal = 3 - jumlahfoto;
								

								Dropzone.autoDiscover = false;

								var foto_upload= new Dropzone("#ikiftmaterialp<?php echo $posting->id_penerangan ?>",{
								url: "<?php echo base_url('penerangan/proses_upload/') ?>" + "<?php echo $posting->id_penerangan ?>",
								maxFilesize: 5,
								maxFiles: maksimal,
								method:"post",
								...
								// Jenis Foto
								foto_upload.on("sending",function(a,b,c){
									a.jenis_foto="Material Penerangan";
									c.append("jenis_foto",a.jenis_foto);
								});
					...
					<!-- Modal edit -->
					<div class="modal fade" id="myModal<?php echo $posting->id_penerangan ?>" tabindex="-1" role="dialog" aria-hidden="true">
					    <div class="modal-dialog modal-lg" role="document">

					    	<!-- <div class="modal fade" id="myModal<?php echo $posting->id_penerangan ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog modal-lg" role="document"> -->
					      ...
					      <div class="modal-content">
					        ...
					        <!-- isi modal -->
					        <div class="modal-body">
					        	<form  action="<?php echo base_url();?>penerangan/edit" method="POST">
									<div class="col-md-6 form-line">
										<input style="visibility: hidden;" type="text" name="key" value="<?php echo $posting->id_penerangan ?>">
							  			<div class="form-group">							  				
							  				<label for="Tanggal">Tanggal :</label>
							  				<?php
							  				date_default_timezone_set('Asia/Jakarta');
									  	...
									  	<div class="form-group">
									    	<label for="perusahaan">Perusahaan :</label>
									    	<select class="form-control" id="perusahaan<?php echo $posting->id_penerangan ?>" name="perusahaan" required>
										      <option value="">-- Pilih Perusahaan --</option>
							  			...
							  			<div class="form-group">
							  				<label for="Vendor">Vendor :</label>
							  				<input class="form-control" type="text" id="vendor<?php echo $posting->id_penerangan ?>" name="vendor" placeholder="Nama Vendor" value="<?php echo $posting->vendor ?>">
							  			</div>
							  			<div class="form-group">
							  				<label for="Foto">Status Foto :</label>
							  				<select class="form-control" id="status_foto" name="status_foto" required>
							  		...
							  		<div class="col-md-6">
							  			<div class="form-group">
											...
											<br>
											<label class="form-check-label">Tetap lokasi awal <input type="radio" class="form-check-input" id="gps<?php echo $posting->id_penerangan ?>" name="gpsedit" checked="checked" value="alamatawal"/></label>

							  				<label class="form-check-label">Lokasi GPS (edit) <input type="radio" class="form-check-input" id="gps<?php echo $posting->id_penerangan ?>" name="gpsedit" value="gps"/></label> 

											<!-- <label class="form-check-label"> &nbsp Input Teks (edit) <input type="radio" class="form-check-input" id="gps<?php echo $posting->id_penerangan ?>" name="gpsedit" value="teks"/> </label> -->

											<input style="" class="form-control" value="<?php echo $posting->alamat ?>" type="text" placeholder="Alamat gps" id="alamatawal<?php echo $posting->id_penerangan ?>" disabled> <!-- ini ditampilkan saja utk alamatawal-->

											<input style="display: none" class="form-control resultgpsedit" type="text" placeholder="Alamat gps" id="tampil<?php echo $posting->id_penerangan ?>" disabled> <!-- ini ditampilkan saja utk gps-->

											<input style="display: none" class="form-control" value="<?php echo $posting->alamat ?>" type="text" id="gpse<?php echo $posting->id_penerangan ?>" name="alamattetap" placeholder="Alamat gps"> <!-- ini inputan tetap -->

											<input style="display: none" class="form-control resultgpsedit" type="text" id="gpse<?php echo $posting->id_penerangan ?>" name="alamat" placeholder="Alamat gps"> <!-- ini inputan gps -->
											...
											<input style="display: none" class="form-control" type="text" id="tekse<?php echo $posting->id_penerangan ?>" name="alamatteks" placeholder="Alamat" >

											<input style="display: none; margin-top: 10px" class="form-control" type="text" id="kota<?php echo $posting->id_penerangan ?>" name="kota" placeholder="Kota" >

											<input style="display: none; margin-top: 10px" class="form-control" type="text" id="prov<?php echo $posting->id_penerangan ?>" name="prov" placeholder="Provinsi" >
											
											<!-- <input type="text" name="otherAnswer" id="otherAnswer"/> -->
							  			</div>

							  			<script>
							  				$("select[id=perusahaan<?php echo $posting->id_penerangan ?>]").change(function(){
											   if($(this).val()=="Vendor")
											   {
											    document.getElementById("vendor<?php echo $posting->id_penerangan ?>").setAttribute("required", "");
											   }
											   else
											   {	
											   	document.getElementById("vendor<?php echo $posting->id_penerangan ?>").removeAttribute("required");
											   }
							  			...
							  			<script>
							  				$("input[type='radio'][id=gps<?php echo $posting->id_penerangan ?>]").change(function(){
											   if($(this).val()=="teks")
											   {
											      document.getElementById("gpse<?php echo $posting->id_penerangan ?>").style.display = 'none';
											      document.getElementById("alamatawal<?php echo $posting->id_penerangan ?>").style.display = 'none';
											      document.getElementById("tampil<?php echo $posting->id_penerangan ?>").style.display = 'none';
											      // $('#gpse').val('');
											      document.getElementById("tekse<?php echo $posting->id_penerangan ?>").style.display = 'block';
											      document.getElementById("kota<?php echo $posting->id_penerangan ?>").style.display = 'block';
											      document.getElementById("prov<?php echo $posting->id_penerangan ?>").style.display = 'block';
											      document.getElementById("tekse<?php echo $posting->id_penerangan ?>").setAttribute("required", "");
											      document.getElementById("kota<?php echo $posting->id_penerangan ?>").setAttribute("required", "");
											      document.getElementById("prov<?php echo $posting->id_penerangan ?>").setAttribute("required", "");
											      document.getElementById("gpse<?php echo $posting->id_penerangan ?>").removeAttribute("required");
											   ...
											   {
											   		// document.getElementById("gpse").style.display = 'block';
											   		document.getElementById("tampil<?php echo $posting->id_penerangan ?>").style.display = 'block';
											   		document.getElementById("alamatawal<?php echo $posting->id_penerangan ?>").style.display = 'none';
											   		document.getElementById("tekse<?php echo $posting->id_penerangan ?>").style.display = 'none';
											   		document.getElementById("kota<?php echo $posting->id_penerangan ?>").style.display = 'none';
											      	document.getElementById("prov<?php echo $posting->id_penerangan ?>").style.display = 'none';
											   		document.getElementById("tekse<?php echo $posting->id_penerangan ?>").removeAttribute("required");
											   		document.getElementById("kota<?php echo $posting->id_penerangan ?>").removeAttribute("required");
											   		document.getElementById("prov<?php echo $posting->id_penerangan ?>").removeAttribute("required");
											   ...
											   {
											   		// document.getElementById("gpse").style.display = 'block';
											   		document.getElementById("alamatawal<?php echo $posting->id_penerangan ?>").style.display = 'block';
											   		document.getElementById("tampil<?php echo $posting->id_penerangan ?>").style.display = 'none';
											   		document.getElementById("tekse<?php echo $posting->id_penerangan ?>").style.display = 'none';
											   		document.getElementById("kota<?php echo $posting->id_penerangan ?>").style.display = 'none';
											      	document.getElementById("prov<?php echo $posting->id_penerangan ?>").style.display = 'none';
					...
					<!-- Modal hapus -->
					<div class="modal fade" id="modalHapus<?php echo $posting->id_penerangan ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="padding-top: 100px;">
					  <div class="modal-dialog modal-lg" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					      ...
					      <div class="modal-footer">
								<form id="form_kpim" method="POST" action="<?php echo base_url();?>penerangan/hapus/<?php echo $posting->id_penerangan?>">
							      	<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<button type="submit" class="btn btn-primary">Hapus</button>
								</form>
					      </div>
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Tahapan <span>Penerangan</span></h2>
				<p class="agileits_dummy_para">Halaman entry laporan penerangan.</p>
