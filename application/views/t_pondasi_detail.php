...
<html lang="en">
<head>
<title>Detail Tahapan Pondasi | Quality Control Application</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header">Detail Tahapan  <span>Pondasi</span></h3>
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>pondasi/laporan"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
			...
			<?php 
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<?php $data_fotoS = $this->db->get_where('foto_pondasi', array('id_posting' => $posting->id_pondasi, 'jenis_foto' => 'Slumtest'))->result(); ?>

					<?php $data_fotoP = $this->db->get_where('foto_pondasi', array('id_posting' => $posting->id_pondasi, 'jenis_foto' => 'Pembesian'))->result(); ?>

					<?php $data_fotoPG = $this->db->get_where('foto_pondasi', array('id_posting' => $posting->id_pondasi, 'jenis_foto' => 'Pengecoran'))->result(); ?>
					...
					<div class="col-md-12">
						...
						<center><b>
							...
							<span style="font-weight: bold;">
								No.TPD/<?php echo date('mY')?>/<?php echo $posting->id_pondasi ?>
							</span>
					...
					<p style="font-style: italic;">Keteragan : <?php echo $posting->ket ?></p>
						...
						<!-- <div class="row" style="margin-bottom: 5px">
					        ...
					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" data-target="#modalFoto150<?php echo $posting->id_pondasi ?>" type="button" class="btn btn-sm form-control">
					...
					<?php
						...
						<span class="album-besar sub-album borderfoto">
							...
							<div class="row hilangkan">
								<div class="col-md-6">
								<a href="<?php echo base_url().'pondasi/lakukan_download/'.$foto->nama_foto ?>"><button class="btn btn-primary form-control" style="margin-top: 5px">Download</button></a>
								</div>
								<div class="col-md-6">
								<a href="<?php echo base_url().'pondasi/lakukan_download_asli/'.$foto->token ?>"><button class="btn btn-warning form-control" style="margin-top: 5px">Download Asli</button></a>
								</div>
							</div>
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Detail Tahapan  <span>Pondasi</span></h2>
				<p class="agileits_dummy_para">Halaman detail laporan Pondasi.</p>
				<!-- <div class="news-w3l">
