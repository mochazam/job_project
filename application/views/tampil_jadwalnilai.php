...
<title>KPIM Online - Jadwal Penilaian Terakhir KPIM</title>
	    ...
	    <div class="container-fluid"> 
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
	                ...
	                <li class="active"><a href="#">Jadwal Penilaian Terakhir KPIM</a></li>
...
<div class="container">
	<div class="background">
		<h1 style="padding-top: 20px; color: orange"><center>Jadwal Penilaian Terakhir KPIM</center></h1><br><br>
	...
	<div class="table-responsive"  style="text-align: center;">
		  ...
		  <tr>
		    ...
		    <td class="tg-2s1i" style="width: 110px"><span class="glyphicon glyphicon-ok"></span></td>
		    <td class="tg-mtwr"></td>
		    <td class="tg-4hfa"></td>
		    <td class="tg-r61r"></td>
		    <td class="tg-yzt1"></td>
		  ...
		  <tr>
		    ...
		    <td class="tg-2s1i" style="width: 110px"><span class="glyphicon glyphicon-ok"></span></span></td>
		    <td class="tg-mtwr"></td>
		    <td class="tg-4hfa"></td>
		    <td class="tg-r61r"></td>
		    <td class="tg-yzt1"></td>
		  ...
		  <tr>
		    ...
		    <td class="tg-2s1i"><span class="glyphicon glyphicon-ok"></span></td>
		  ...
		  <tr>
		    ...
		    <td class="tg-4hfa"></td>
		    <td class="tg-r61r"></td>
		    <td class="tg-yzt1" style="width: 110px"></td>
		    <td class="tg-dza"></td>
		  </tr>
		  <tr>
	...
	<center><img class="img-responsive" src="<?php echo base_url() ?>/assets/img/menilai.png" alt="Tabel menilai karyawan" title="Tabel menilai karyawan"></center>
		<div class="row">
			<div class="col-sm-12">
