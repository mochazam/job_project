...
.tabs {
  ...
  .tabs [class*=" tab"] [type="radio"] {
    ...
    .tabs [class*=" tab"] [type="radio"]:focus {
      border-bottom: 3px solid #cc810a; }
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active dropdown">
                      <a href="#" class="dropdown-toggle active" data-toggle="dropdown">Grafik Rata-Rata Semua karyawan <span class="caret"></span></a>
                            ...
                            <li>
                                <div class="navbar-login navbar-login-session">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <p>
                                                <a href="<?php echo base_url();?>login/logout" class="btn btn-warning btn-block" style="font-family: 'Exo 2', sans-serif; margin: 0px 25px ">Logout</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
<?php $thnku = $thn;?>
    ...
    <div class="row"><h2><center>Grafik Rata-Rata Semua Karyawan</center></h2></div>
    ...
    <div class="tab">
      ...
      <div style="float: right; padding: 10px 15px 7px 7px"><a class= "btn btn-warning" href="<?php echo base_url(); ?>Reportkaryawan" style="font-family: 'Exo 2', sans-serif;"><span class="glyphicon glyphicon-arrow-left"></span><h7><i> Kembali</i></h7></a></div>
                  ...
                  <script type="text/javascript">
                      ...
                      var chart = Highcharts.chart('januari', {
                            ...
                            enabled: false
                              ...
                              subtitle: {
                                  text: tanggal + awal + sampai + akhir
                              },
            ...
            <div class="tab-2">
              ...
              <!-- <text style="padding-left: 25px; color: black"><i><?php echo $nama->nama_karyawan;?>, <?php echo $nama->nama_akses;?> - <?php echo $nama->nama_dept;?></i></text>       -->
                <p>
                    ...
                    <br/>
                  <center >
                  <button type="button" class="btn btn-warning" id="plain" style="font-family: 'Exo 2', sans-serif;"><span class="glyphicon glyphicon-stats"></span> Plain</button>
                  <button type="button" class="btn btn-warning" id="inverted" style="font-family: 'Exo 2', sans-serif;">Inverted</button>
                  <button type="button" class="btn btn-warning" id="polar" style="font-family: 'Exo 2', sans-serif;">Polar</button>
                  </center>
    ...
    <button class="btn btn-warning ini" id="hide" style="font-family: 'Exo 2', sans-serif; display: none">Sembunyikan</button>    
    </div>
<br><br>
    <div class="row ini" style="display: none">
        ...
        <div class="col-sm-12">            
          ...
          <table class="tg" style="float:center;">
            ...
            <tr>
              <td class="tg-giv5" style="color: black">Score : </td>
              <td class="tg-giv5" style="color: black">0 - 40</td>
              <td class="tg-giv5" style="color: black">>40 - 60</td>
              <td class="tg-giv5" style="color: black">>60 - 75</td>
              <td class="tg-7ygo" style="color: black">>75 - 85</td>
              <td class="tg-7ygo" style="color: black">>85 - 100</td>
            </tr>
            <tr>
    ...
    <br><br>
        ...
        <!-- <center>
        <button type="button" class="btn btn-warning" id="plain">Plain</button>
        <button type="button" class="btn btn-warning" id="inverted">Inverted</button>
        <button type="button" class="btn btn-warning" id="polar">Polar</button>
        </center> -->
