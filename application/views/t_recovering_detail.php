...
<html lang="en">
<head>
<title>Detail Tahapan Recovering | Quality Control Application</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header">Detail Tahapan  <span>Recovering</span></h3>
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>recovering/laporan"><button class="btn btn-danger" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
			...
			<?php 
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<div class="col-md-12">
						...
						<center><b>
							...
							<span style="font-weight: bold;">
								No.TR/<?php echo date('mY')?>/<?php echo $posting->id_recovering ?>
							</span>
					...
					<p style="font-style: italic;">Keteragan : <?php echo $posting->ket ?></p>
						...
						<!-- <div class="row" style="margin-bottom: 5px">
							<div class="col-md-4">
								<button data-toggle="modal" style="height: 50px; color: white; background-color: #184169"" data-target="#modalFoto<?php echo $posting->id_recovering ?>" type="button" class="btn btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto 50 M
						        </button>
					        </div>

					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #13314D" " data-target="#modalFoto100<?php echo $posting->id_recovering ?>" type="button" class="btn btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto 100 M
						        </button>
					    	</div>

					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" data-target="#modalFoto150<?php echo $posting->id_recovering ?>" type="button" class="btn btn-sm form-control">
					    ...
					    <!-- <div class="row">
					        <div class="col-md-6">
								<button data-toggle="modal" data-target="#myModal<?php echo $posting->id_recovering ?>" id="editku" type="button" class="btn btn-warning btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-edit"></span> Edit
						        </button>
					        </div>

					        <div class="col-md-6">
						        <button data-toggle="modal" data-target="#modalHapus<?php echo $posting->id_recovering ?>" type="button" class="btn btn-danger btn-sm form-control">
					...
					<?php
						...
						<span class="album-besar sub-album borderfoto">
							...
							<div class="row hilangkan">
								<div class="col-md-6">
								<a href="<?php echo base_url().'recovering/lakukan_download/'.$foto->nama_foto ?>"><button class="btn btn-primary form-control" style="margin-top: 5px">Download</button></a>
								</div>
								<div class="col-md-6">
								<a href="<?php echo base_url().'recovering/lakukan_download_asli/'.$foto->token ?>"><button class="btn btn-warning form-control" style="margin-top: 5px">Download Asli</button></a>
								</div>
							</div>
				...
				<div class="panel panel-default" style="margin-top: 80px; border: 2px black solid">
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Detail Tahapan  <span>Recovering</span></h2>
				<p class="agileits_dummy_para">Halaman detail laporan Recovering.</p>
				<!-- <div class="news-w3l">
