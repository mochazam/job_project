...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			...
			<p class="agileits_dummy_para"><a href="<?php echo base_url(); ?>penerangan/terkirim"><button class="btn btn-primary" style="width: 200px"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Kembali</button></a></p>
			<br><br>
		<div id="ygdiprint">
				...
				<?php $tgl = $posting->tanggal ;?>
					...
					<p style="font-style: italic;">Keteragan : <?php echo $posting->ket ?></p>
						...
						<!-- <div class="row" style="margin-bottom: 5px">
							<div class="col-md-4">
								<button data-toggle="modal" style="height: 50px; color: white; background-color: #184169"" data-target="#modalFoto<?php echo $posting->id_pondasi ?>" type="button" class="btn btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto 50 M
						        </button>
					        </div>

					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #13314D" " data-target="#modalFoto100<?php echo $posting->id_pondasi ?>" type="button" class="btn btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-plus-sign"></span> Tambah Foto 100 M
						        </button>
					    	</div>

					        <div class="col-md-4">
						        <button data-toggle="modal" style="height: 50px; color: white; background-color: #121C25" data-target="#modalFotoPG<?php echo $posting->id_pondasi ?>" type="button" class="btn btn-sm form-control">
					    ...
					    <!-- <div class="row">
					        <div class="col-md-6">
								<button data-toggle="modal" data-target="#myModal<?php echo $posting->id_pondasi ?>" id="editku" type="button" class="btn btn-warning btn-sm form-control">
						        <span  style="color: white" class="glyphicon glyphicon-edit"></span> Edit
						        </button>
					        </div>

					        <div class="col-md-6">
						        <button data-toggle="modal" data-target="#modalHapus<?php echo $posting->id_pondasi ?>" type="button" class="btn btn-danger btn-sm form-control">
