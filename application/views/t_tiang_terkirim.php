...
<html lang="en">
<head>
<title>Laporan Terkirim Tahapan Tiang | Quality Control Application</title>
...
Sidoarjo - East Java, 61257</p>
	...
	<div class="contact">
		<div class="container">
			<h3 class="agileinfo_header"><span style="color: maroon">Laporan Terkirim</span> Tahapan Tiang</h3>
			<p class="agileits_dummy_para">Dapat melihat seluruh laporan langsung atau lihat laporan berdasarkan periode tanggal</p>
			<br><br>
			

			<form id="form_laporan" action="<?php echo base_url();?>tiang/laporantglterkirim" method="POST">
				<div class="row">
			...
			<br>		
			<a href="<?php echo base_url() ?>tiang/terkirim"><button class="btn btn-primary"><span style="color: white" class="glyphicon glyphicon-arrow-left"></span> Tampilkan Semua Laporan Terkirim</button></a><br><br>
			<?php } ?>
					...
					<table id="dataTables"class="display table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
				        <thead>
				            <t>
				                ...
				                <th style="text-align: center; color: black">ID Tiang</th>
						...
						<tbody >
									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black"><?php echo $u->id_tiang ?></td>
											...
											<td style="text-align: center; color: black">
												<form id="Detail" action="<?php echo base_url();?>tiang/detailterkirim/<?php echo $u->id_tiang ?>" method="POST">
													<!-- <input type="text" name="id_tiang" style="visibility: hidden;" value="<?php echo $u->id_tiang ?>"> -->
...
<div class="footer">
		<div class="container">
			<h2 class="agileinfo_header">Laporan Terkirim <span>Tahapan Tiang</span></h2>
				<p class="agileits_dummy_para">Halaman laporan terkirim tiang.</p>
