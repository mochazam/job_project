...
class Konstruksi extends CI_Controller {
	...
	public function __construct() {
		parent::__construct();
        $this->load->database();
        $this->load->model(array('M_kpimmingguan', 'M_konstruksi', 'app_model'));
	...
	public function index()
	{
        ...
        $data['table'] = $this->M_konstruksi->getPosting()->result();
		$this->load->view('t_konstruksi', $data);
    ...
    public function laporan()
    {
        $this->app_model->getLogin();
        // $data['profilku'] = $this->M_kpimmingguan->getdataku()->result();
        $data['semua'] = $this->M_konstruksi->getsemuaPosting()->result();
        $this->load->view('t_konstruksi_lap', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function laporantgl()
    {
        $this->app_model->getLogin();
         if( $this->input->post('tglstart')==null  & $this->input->post('tglend')==null){
            redirect(base_url() . 'konstruksi/laporan', 'refresh');
         }
        // $data['profilku'] = $this->M_kpimmingguan->getdataku()->result();
        ...
        $data['start'] = $tglstart;
        $data['end'] =$tglend;
        $data['semua'] = $this->M_konstruksi->getPostingtgl($tglstart, $tglend)->result();
        $this->load->view('t_konstruksi_lap', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function detail($id)
    {
        ...
        // $data['profilku'] = $this->M_kpimmingguan->getdataku()->result();
        // $id = $this->input->post('id_konstruksi');
        $data['table'] = $this->M_konstruksi->getdetailPosting($id)->result();
        $this->load->view('t_konstruksi_detail', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function terkirim()
    {
        $this->app_model->getLogin();
        // $data['profilku'] = $this->M_kpimmingguan->getdataku()->result();
        $data['semua'] = $this->M_konstruksi->getPostingterkirim()->result();
        $this->load->view('t_konstruksi_terkirim', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function detailterkirim($id )
    {
        ...
        // $data['profilku'] = $this->M_kpimmingguan->getdataku()->result();
        $data['table'] = $this->M_konstruksi->getdetailPosting($id)->result();
        $this->load->view('t_konstruksi_detailterkirim', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function laporantglterkirim()
    {
        ...
        $data['start'] = $tglstart;
        $data['end'] =$tglend;
        $data['semua'] = $this->M_konstruksi->getPostingtglterkirim($tglstart, $tglend)->result();
        $this->load->view('t_konstruksi_terkirim', $data);
        // $this->load->view('t_recor', $data);
        // $this->load->view('upload_view');
    }
    ...
    public function hapus($key){
        ...
        $this->M_konstruksi->delete($key);

        // delete foto mulai
        $foto=$this->db->get_where('foto_konstruksi',array('id_posting'=>$key));
        if ($foto->num_rows() > 0) {
            ...
            foreach ($n as $nm_foto) {
                if(file_exists($file=FCPATH.'/assets/upload-foto/konstruksi/'.$nm_foto)){
                unlink($file);
                }    
            }
            
            $this->db->delete('foto_konstruksi',array('id_posting'=>$key));
        }

        // mulai delete foto asli

        $foto_asli=$this->db->get_where('foto_konstruksi_asli',array('id_posting'=>$key));
        if ($foto_asli->num_rows() > 0) {
            ...
            foreach ($n_asli as $nm_foto_asli) {
                if(file_exists($file_asli=FCPATH.'/assets/upload-foto/konstruksi/'.$nm_foto_asli)){
                unlink($file_asli);
                }    
            }
            
            $this->db->delete('foto_konstruksi_asli',array('id_posting'=>$key));
        }

        // if($foto->num_rows()>0){
        //     $hasil=$foto->row();
        //     $nama_foto=$hasil->nama_foto;
        //     if(file_exists($file=FCPATH.'/assets/upload-foto/konstruksi/'.$nama_foto)){
        //         unlink($file);
        //     }
        //     $this->db->delete('foto_konstruksi',array('id_posting'=>$key));
        // }

        redirect(base_url() . 'konstruksi', 'refresh');
    }
	...
	public function create() {
        ...
        $this->M_konstruksi->get_insert($data);
        redirect(base_url() . 'konstruksi', 'refresh' );
    ...
    public function edit() {
        ...
        $this->M_konstruksi->get_update($key, $data);
        redirect(base_url() . 'konstruksi', 'refresh' );
    ...
    */
    ...
    function proses_upload($id_posting){
        ...
        $config['upload_path']   = './assets/upload-foto/konstruksi/';
        ...
        if($this->upload->do_upload('userfile')){
            ...
            $this->db->insert('foto_konstruksi',array('nama_foto'=>$nama, 'id_posting'=>$id_posting, 'id_kar_upload'=>$ygupload, 'jenis_foto'=>$jns_ft, 'token'=>$token));
    ...
    function proses_upload_asli($id_posting){
        ...
        if($this->upload->do_upload('userfile')){
            ...
            $this->db->insert('foto_konstruksi_asli',array('nama_foto'=>$nama, 'id_posting'=>$id_posting, 'id_kar_upload'=>$ygupload, 'jenis_foto'=>$jns_ft, 'token'=>$token));
    ...
    public function lakukan_download($nama_foto){             
        force_download('./assets/upload-foto/konstruksi/'.$nama_foto,NULL);
    }

    public function lakukan_download_asli($token){
        $data = $this->db->get_where('foto_konstruksi_asli', array('token' => $token))->result();
        foreach ($data as $key) {
            force_download('./assets/upload-foto/konstruksi/'.$key->nama_foto,NULL);
        }
    ...
    function remove_foto(){
        ...
        $foto=$this->db->get_where('foto_konstruksi',array('token'=>$token));
        ...
        if($foto->num_rows()>0){
            ...
            $this->db->delete('foto_konstruksi',array('token'=>$token));
    ...
    function remove_foto_asli(){
        ...
        $foto=$this->db->get_where('foto_konstruksi_asli',array('token'=>$token));
        ...
        if($foto->num_rows()>0){
            ...
            $this->db->delete('foto_konstruksi_asli',array('token'=>$token));
    ...
    function hapus_fotosatu($id){
        ...
        $foto=$this->db->get_where('foto_konstruksi',array('id'=>$id));
        ...
        if($foto->num_rows()>0){
            ...
            $this->db->delete('foto_konstruksi',array('id'=>$id));

        }

        // $data_foto = $this->db->get_where('foto_konstruksi', array('id_posting' => $posting->id_konstruksi, 'jenis_foto' => '50'))->result();
    ...
    function hapus_fotosatu_asli($tokenku){
        ...
        $foto=$this->db->get_where('foto_konstruksi_asli',array('token'=>$tokenku));
        ...
        if($foto->num_rows()>0){
            ...
            $this->db->delete('foto_konstruksi_asli',array('token'=>$tokenku));
    ...
    public function updatestatus(){
        ...
        $this->M_konstruksi->updatestatus($key, $id, $data);
